...
// image default alt
if ( ! function_exists( 'mosh_img_default_alt' ) ) {
	function mosh_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'mosh_img_tag' ) ) {
	function mosh_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'mosh_anchor_tag' ) ) {
	function mosh_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'mosh_heading_tag' ) ) {
	function mosh_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'mosh_paragraph_tag' ) ) {
	function mosh_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'mosh_other_tag' ) ) {
	function mosh_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'mosh_button_element ' ) ) {
	function mosh_button_element( array $args ) {
