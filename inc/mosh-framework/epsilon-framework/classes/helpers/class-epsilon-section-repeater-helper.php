			...
			switch ( $prop ) {
				case 'background-color':
					$temp = array(
						...
						'label'       => __( 'Background color', 'mosh' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'epsilon-color-picker',
						'mode'        => 'hex',
				...
				case 'background-color-opacity':
					$temp = array(
						...
						'label'       => __( 'Background color opacity', 'mosh' ),
						'description' => '',
						'type'        => 'epsilon-slider',
				...
				case 'background-image':
					$temp = array(
						...
						'label'       => __( 'Background image', 'mosh' ),
						'description' => '',
						'type'        => 'epsilon-image',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'group'       => 'styling',
				...
				case 'background-position':
					$temp = array(
						...
						'label'       => __( 'Background position', 'mosh' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'topleft'     => __( 'Top Left', 'mosh' ),
							'top'         => __( 'Top', 'mosh' ),
							'topright'    => __( 'Top Right', 'mosh' ),
							'left'        => __( 'Left', 'mosh' ),
							'center'      => __( 'Center', 'mosh' ),
							'right'       => __( 'Right', 'mosh' ),
							'bottomleft'  => __( 'Bottom Left', 'mosh' ),
							'bottom'      => __( 'Bottom', 'mosh' ),
							'bottomright' => __( 'Bottom Right', 'mosh' ),
						),
					);
				...
				case 'background-repeat':
					$temp = array(
						...
						'label'       => __( 'Background repeat', 'mosh' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'no-repeat' => __( 'No Repeat', 'mosh' ),
							'repeat'    => __( 'Repeat', 'mosh' ),
							'repeat-y'  => __( 'Repeat Y', 'mosh' ),
							'repeat-x'  => __( 'Repeat X', 'mosh' ),
						),
					);
				...
				case 'background-size':
					$temp = array(
						...
						'choices'     => array(
							'cover'   => __( 'Cover', 'mosh' ),
							'contain' => __( 'Contain', 'mosh' ),
							'initial' => __( 'Initial', 'mosh' ),
						),
					);
				...
				case 'background-parallax':
					$temp = array(
						...
						'label'       => __( 'Background parallax', 'mosh' ),
						'description' => '',
				...
				case 'background-video':
					$temp = array(
						...
						'label'       => __( 'Background video', 'mosh' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'text',
						'group'       => 'styling',
			...
			switch ( $prop ) {
				case 'column-alignment':
					$temp = array(
						...
						'label'   => __( 'Horizontal alignment', 'mosh' ),
						'group'   => 'layout',
				...
				case 'column-vertical-alignment':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Vertical alignment', 'mosh' ),
						'group'   => 'layout',
				...
				case 'row-title-align':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Title & description alignment', 'mosh' ),
						'group'   => 'layout',
