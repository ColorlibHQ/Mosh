 ...
 */
	...
	class mosh_Enqueue{
		...
		public function mosh_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'mosh_frontend_enqueue_scripts', ) );
		}

		public function mosh_frontend_enqueue_scripts( ){
